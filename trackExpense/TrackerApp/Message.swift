...
let kMsgEmptyPassword = "Please enter your password"
let kMsgEmptyConfirmPassword = "Please confirm your password"
let kMsgMinimumPasswordLength = "Password must be at least 6 characters long"
let kMsgEmail = "Please input Email"
let kMsgFormatPhone = "Vui lòng nhập vào số điện thoại đúng định dạng"
let kMsgEnterPassword = "Re-enter a different password, please try again"
