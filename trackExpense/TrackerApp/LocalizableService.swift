...
//            if UserDefaultsInApp().current_language == language.rawValue {
//                language = .en
//            }
            return language
        }
    ...
    func clearLanguages() {
//        var user = UserDefaultsInApp()
//        user.current_language = nil
    }
...
//        let user = UserDefaultsInApp()
//        guard let currentLanguage = user.current_language else {
//            return
//        }
//
