...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ContextMenuSwift/ContextMenuSwift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KAPinField/KAPinField.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NextLevelSessionExporter/NextLevelSessionExporter.framework"
